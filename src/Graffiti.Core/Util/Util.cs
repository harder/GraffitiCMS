        ...
        public static bool CanWrite(HttpContext cntx)
        {
            try
            {
                if (!_canWrite)
                {
                    ...
                    {
                        sw.WriteLine("Temporary file generated by Graffiti CMS to test for write access. If you see this file, it is likely your server is not properly configured to support Graffiti. Please see http://graffiticms.codeplex.com/documentation for more help.");
                        sw.Close();
                    }
