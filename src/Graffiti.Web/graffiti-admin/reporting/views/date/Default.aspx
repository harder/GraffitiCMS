...
<script runat="server">
	protected override void OnLoad(EventArgs e)
	{
		...
		Date.Text = date.ToString("d");
                ...
                <h3>Views by Post for <asp:Literal ID="Date" runat="server" /> (Top 10)</h3>
	            <div id="barchart">
	            ...
	            <script type="text/javascript">
		            // <![CDATA[
                        ...
                        so.addVariable("data_file", escape("../../charts.ashx?report=ViewsByDate_Single&year=<%=Request.QueryString["year"] %>&month=<%=Request.QueryString["month"] %>&day=<%=Request.QueryString["day"] %>"));
